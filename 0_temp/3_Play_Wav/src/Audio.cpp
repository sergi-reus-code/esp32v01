...
size_t AudioBuffer::writeSpace() {
    ...
    //AUDIO_INFO(m_readPtr);
    //AUDIO_INFO("redirect to new extension at existing host \"%s\"", m_readPtr);
    
    //Serial.println(int(m_readPtr));
    //Serial.println("-");
    //Serial.println(int(m_writePtr));
    //Serial.println(m_readPtr);
    //Serial.println("m_writePtr");
    //Serial.println(m_writePtr);
...
void Audio::processLocalFile() {
    ...
    availableBytes = _min(availableBytes, InBuff.writeSpace());
    //Serial.println(InBuff.writeSpace());


    availableBytes = _min(availableBytes, audiofile.size() - byteCounter);
...
bool Audio:: initializeDecoder(){
    switch(m_codec){
        ...
        case CODEC_WAV:
            ...
            AUDIO_INFO("WAVDecoder has been initialized, free Heap: %u bytes", ESP.getFreeHeap());
            break;
        case CODEC_OGG:
            m_codec = CODEC_OGG;
